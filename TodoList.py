...
#################################################################
time = "10:30am"  #ここを変更して通知時間を指定する． 下のパスはそれぞれに合わせて．
#################################################################
cronpi.run_every_day("/usr/local/bin/python3.9 /Users/e195765/Desktop/2年講義/ソフトウェア開発演習/group11/Software_Dev_Group11/push.py").on(time)
...
task_deadline.insert(tkinter.END,"ここに期限を入力  例("+str(dt_now.month)+"/7日なら'7'と入力)")
